    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(blank=True, help_text='투두 설명 입니다.', max_length=256, verbose_name='투두 설명')),
                ('author', models.CharField(help_text='투두 작성자를 나타냅니다.', max_length=16, verbose_name='투두 작성자')),
                ('due_date', models.DateField(help_text='투두 마감일을 나타냅니다.', verbose_name='투두 마감일')),
